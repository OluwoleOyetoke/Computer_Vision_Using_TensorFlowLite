...
REFERENCE:
--------------
Code adapted from here: https://github.com/yeephycho/tensorflow_input_image_by_tfrecord/blob/master/src/flower_train_cnn.py#L1
http://yeephycho.github.io/2016/08/15/image-data-in-tensorflow/


Code written to:
    Create the AlexNet CNN structure
    Train the CNN Network using Images stored in a TF Record
    Evaluate and Test the Network Performance
...
# WRAPPER FOR INSERTING int64 FEATURES & BYTES FEATURES INTO EXAMPLES PROTO
"""-------------------------------------------------------------------------------------------------------------------------------------------------------"""
...
# CLASS CONTAINING FUNCTIONS TO GET IMAGE OBJECT/DETAILS FROM EXAMPLE PROTO
"""-------------------------------------------------------------------------------------------------------------------------------------------------------"""
class _image_object:
    def __init__(self):
